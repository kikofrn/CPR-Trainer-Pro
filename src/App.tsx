                ...
                <div className="max-w-5xl w-full mx-auto bg-[#131313]/90 border border-white/10 rounded-[32px] p-8 md:p-12 shadow-2xl relative overflow-hidden">
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-[1fr_0.8fr] gap-12 items-start mt-4">
                    ...
                    <div className="flex flex-col items-start justify-start">
                      ...
                      {/* Compliance text moved beneath cards */}
                    </div>
                    ...
                    <div className="flex flex-col items-end justify-center w-full bg-black/20 rounded-2xl p-6 border border-white/5">
                      ...
                      <div className="mt-8 pt-5 border-t border-white/10 w-full text-left">
                        <p className="text-[11px] text-eh-peach/50 leading-relaxed">
                          Everyday Hero Academy provides nationally recognized, fully compliant CPR and First Aid certifications built strictly on the latest 2025 AHA/ILCOR scientific standards. Because our curriculum mandates live, in-person skills assessments, our pediatric and adult cards meet or exceed all federal OSHA workplace safety requirements and satisfy state child-care licensing mandates including pediatric hands-on skills validation. To view our comprehensive state-by-state approval registry or download your compliance packet, visit <button onClick={() => handleOpenExternalUrl("https://ehacademy.com")} className="text-eh-blue hover:underline cursor-pointer inline font-bold">ehacademy.com</button>
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div className="max-w-3xl w-full mx-auto bg-[#131313] border border-white/10 rounded-[24px] p-8 md:p-12 shadow-2xl relative overflow-hidden flex flex-col items-center justify-start">
                  ...
                  <div className="mt-4 pt-6 border-t border-white/10 w-full text-center">
                    <p className="text-[11px] text-eh-peach/50 leading-relaxed max-w-md mx-auto">
                      ...
                      <button 
                        onClick={() => handleOpenExternalUrl("https://ehacademy.com")}
